    ...
    <div class="container">
        ...
        <div class="mt-3 mb-4">
            <a href="{{ route('home') }}" class="d-block">
                ...
                @else
                    <!--<img class="lazyload h-45px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logologo.jpeg') }}" alt="{{ env('APP_NAME') }}" height="45"> -->
                
                
                <div class="d-flex align-items-center">
    <img class="lazyload h-45px" 
         src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" 
         data-src="{{ static_asset('assets/img/logologo.jpeg') }}" 
         alt="{{ env('APP_NAME') }}" 
         height="45">
          @endif

    <div class="ml-2">
        <div style="font-size: 16px; font-weight: 600; color: #D32F2F; line-height: 1;">
            ARTISTIQE
        </div>
    </div>
</div>
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p  class="fs-13 text-soft-light">307B, 3rd Floor, I Thum Tower-A, A-40, Sector 62, Noida, Uttar Pradesh 201301</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Phone') }}</p>
                            <p  class="fs-13 text-soft-light">08920877101</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Email') }}</p>
                            <p  class="">
                                <a href="mailto:{{ get_setting('contact_email') }}" class="fs-13 text-soft-light hov-text-primary">nktechipl@gmail.com</a>
                            </p>
                        </li>
                    </ul>
                </div>
