                ...
                <div class="d-flex align-items-center">
                   ...
                   <!-- <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @else
                                <img src="{{ static_asset('assets/img/logologo.jpeg') }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-30px h-md-40px" height="40">
                                    
                            @endif
                            <span class="ml-2 h5 mb-0">ARTISTIQE</span>
                        </a>
                    </div> -->
...
<!-- Header Logo -->
<div class="col-auto pl-0 pr-3 d-flex align-items-center">
    <a class="d-flex align-items-center py-20px mr-3 ml-0" href="{{ route('home') }}">
        @php
            $header_logo = get_setting('header_logo');
        @endphp
        @if ($header_logo != null)
